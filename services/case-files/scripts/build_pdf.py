...
pg.fields([('Full name', 'RAVI SHARMA'), ('Father\'s name', 'Late Gopal Sharma'), ('Date of birth / age', '03-06-1957 / 61 years'), ('Sex', 'Male'), ('Occupation', 'Retired engineer (BEML, 2016)'), ('Residence', 'No. 42, 8th Cross, Malleshwaram, Bengaluru 560003'), ('Mobile', '98450 22417'), ('Identification', 'Spectacles; short grey beard; scar on left knee. Identified by daughter from the wallet and person.'), ('Next of kin', 'Smt. Lakshmi Sharma (wife, 58), same address'), ('Children', 'Smt. Meera Kapoor (daughter, 26), w/o Sri Arjun Kapoor, r/o Koramangala, Bengaluru'), ('Informed', 'Wife by phone 09:30 hrs; daughter reached the scene 10:20 hrs')], width=W - 2 * M - PW - 14)
pg.h('Brief facts')
...
pg.fields([('Deceased', 'Ravi Sharma, M, 61 yrs, S/o late Gopal Sharma, r/o Malleshwaram'), ('Brought by', 'PC 4471, Turahalli PS'), ('Identified by', 'Smt. Meera Kapoor (daughter) and Smt. Lakshmi Sharma (wife)'), ('Examined', '15-10-2018, 10:30 hrs'), ('Examiner', 'Dr. S. Hegde, Asst. Professor')])
...
pg.y -= 70
pg.p('Copy issued to Smt. Lakshmi Sharma (wife) and Smt. Meera Kapoor (daughter) on request, 19-10-2018, and closure page on 08-11-2018. Effects (page 2) handed over to the daughter against receipt, 19-10-2018. -- Station Writer', size=8, color=FADED)
