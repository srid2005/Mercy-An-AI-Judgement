...
const appReducer = (state = defState, action) => {
  ...
  if (action.type == "ORBITSITE") {
    ...
    obj.url = action.payload ? action.payload : null;
    ...
    return tmpState;
  } else if (action.type == "PHOTOSOPEN") {
    var obj = { ...tmpState["photos"] };
    obj.file = action.payload; // { name, src, folder, list: [{name, src}] }
    obj.size = "full";
    obj.hide = false;
    obj.max = true;
    tmpState.hz += 1;
    ...
    tmpState["photos"] = obj;
    return tmpState;
  } else if (action.type == "VIDEOOPEN") {
    var obj = { ...tmpState["movies"] };
    obj.file = action.payload; // { name, src, folder }
    obj.size = "full";
    obj.hide = false;
    obj.max = true;
    tmpState.hz += 1;
    ...
    tmpState["movies"] = obj;
    return tmpState;
  } else if (action.type == "NOTEPADOPEN") {
    var obj = { ...tmpState["notepad"] };
    obj.file = action.payload; // { name, text }
    obj.size = "full";
    obj.hide = false;
    obj.max = true;
    tmpState.hz += 1;
